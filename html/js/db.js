...
window.addQuestion = (type, content, answers) => {
    return new Promise((resolve, reject) => {
        ...
        if (typeof type != "string" || !type.length)
            return reject(
                "Parameter 'type' needs to be a non-empty string. it is " +
                    typeof type
            );
        if (typeof content != "string" || !content.length)
            return reject(
                "Parameter 'content' needs to be a non-empty string. it is " +
                    type
            );
...
window.deleteQuestion = async (type, content) => {
    return new Promise((resolve, reject) => {
        if (typeof type != "string" || !type.length)
            return resolve("Parameter 'type' needs to be a non-empty string.");
        if (typeof content != "string" || !content.length)
            return resolve(
