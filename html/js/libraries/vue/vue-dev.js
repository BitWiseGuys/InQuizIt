    ...
    ***************************************************************************** */
        ...
        if (!isPlainObject(target)) {
            {
                if (isArray(target)) {
                    ...
                    warn$2(
                        "value cannot be made readonly: ".concat(typeof target)
                    );
                }
            }
            return target;
                ...
                if (isPromise(res_1)) {
                    ...
                    if (isDef(res_1.timeout)) {
                        ...
                        timerTimeout_1 = setTimeout(function () {
                            ...
                            if (isUndef(factory.resolved)) {
                                reject_1(
                                    "timeout (".concat(res_1.timeout, "ms)")
                                );
                            }
                        }, res_1.timeout);
                    }
        ...
        if (flush === "sync") {
            ...
            watcher.update = function () {
                if (
                    ...
                    var buffer =
                        instance._preWatchers || (instance._preWatchers = []);
    ...
    strats.provide = function (parentVal, childVal) {
        ...
        return function () {
            ...
            mergeData(
                ret,
                isFunction(parentVal) ? parentVal.call(this) : parentVal
            );
            if (childVal) {
                mergeData(
                    ret,
                ...
                if (element.elseif || element.else) {
                    ...
                    if (element.slotScope) {
                        ...
                        (currentParent.scopedSlots ||
                            (currentParent.scopedSlots = {}))[name_1] = element;
                    }
    ...
    function genScopedSlots(el, slots, state) {
        ...
        if (!needsForceUpdate) {
            ...
            while (parent_2) {
                if (
                    (parent_2.slotScope &&
                        parent_2.slotScope !== emptySlotScopeToken) ||
                    parent_2.for
                ) {
                    needsForceUpdate = true;
                    break;
    ...
    function genSlot(el, state) {
        ...
        var res = "_t("
            .concat(slotName)
            .concat(
                children ? ",function(){return ".concat(children, "}") : ""
            );
        var attrs =
